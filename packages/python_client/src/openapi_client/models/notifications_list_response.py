...
T = TypeVar("T", bound="NotificationsListResponse")
...
class NotificationsListResponse:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    for notifications_item_data in _notifications:
      notifications_item = NotificationResponse.from_dict(notifications_item_data)

      notifications.append(notifications_item)

    unread_count = d.pop("unread_count")

    notifications_list_response = cls(
      notifications=notifications,
      unread_count=unread_count,
    )

    notifications_list_response.additional_properties = d
    return notifications_list_response
