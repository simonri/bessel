...
T = TypeVar("T", bound="WorkoutLogDetailSchema")


@_attrs_define
class WorkoutLogDetailSchema:
  """
  Attributes:
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    for sets_item_data in _sets:
      sets_item = WorkoutSetSchema.from_dict(sets_item_data)

      sets.append(sets_item)

    workout_log_detail_schema = cls(
      created_at=created_at,
      modified_at=modified_at,
      id=id,
      started_at=started_at,
    ...
    workout_log_detail_schema.additional_properties = d
    return workout_log_detail_schema
