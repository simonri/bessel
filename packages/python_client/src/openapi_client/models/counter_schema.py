...
T = TypeVar("T", bound="CounterSchema")
...
class CounterSchema:
  ...
  Attributes:
      ...
      name (str):
      last_reset_at (datetime.datetime | None):
      reset_count (int):
  """
  ...
  def to_dict(self) -> dict[str, Any]:
    ...
    if isinstance(self.last_reset_at, datetime.datetime):
  ...
  def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
    ...
    def _parse_last_reset_at(data: object) -> datetime.datetime | None:
      if data is None:
        return data
      try:
        if not isinstance(data, str):
          raise TypeError()
        last_reset_at_type_0 = datetime.datetime.fromisoformat(data)

        return last_reset_at_type_0
      except (TypeError, ValueError, AttributeError, KeyError):
        pass
      return cast(datetime.datetime | None, data)
    ...
    counter_schema.additional_properties = d
