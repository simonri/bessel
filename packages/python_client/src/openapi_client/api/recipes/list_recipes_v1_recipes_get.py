...
from ...models.recipe_sort_property import RecipeSortProperty
...
def _get_kwargs(
  *,
  ...
  page: int | Unset = 1,
  limit: int | Unset = 10,
  sorting: list[RecipeSortProperty] | None | Unset = UNSET,
) -> dict[str, Any]:
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> HTTPValidationError | RecipeListResponse | None:
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[HTTPValidationError | RecipeListResponse]:
  return Response(
...
def sync_detailed(
  *,
  ...
  limit: int | Unset = 10,
  sorting: list[RecipeSortProperty] | None | Unset = UNSET,
) -> Response[HTTPValidationError | RecipeListResponse]:
  """List Recipes
  ...
  Args:
      ...
      sorting (list[RecipeSortProperty] | None | Unset): Sorting criterion. Several criteria can
...
def sync(
  *,
  ...
  limit: int | Unset = 10,
  sorting: list[RecipeSortProperty] | None | Unset = UNSET,
) -> HTTPValidationError | RecipeListResponse | None:
  """List Recipes
  ...
  Returns:
      HTTPValidationError | RecipeListResponse
  """
