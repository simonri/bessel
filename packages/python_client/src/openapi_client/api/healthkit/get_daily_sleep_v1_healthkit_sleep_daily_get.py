...
from ...models.sleep_daily_response import SleepDailyResponse
...
def _parse_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> HTTPValidationError | SleepDailyResponse | None:
  if response.status_code == 200:
    response_200 = SleepDailyResponse.from_dict(response.json())
...
def _build_response(*, client: AuthenticatedClient | Client, response: httpx.Response) -> Response[HTTPValidationError | SleepDailyResponse]:
  return Response(
...
def sync_detailed(
  *,
  ...
  tz_name: None | str | Unset = UNSET,
  tz_offset_mins: int | Unset = 0,
) -> Response[HTTPValidationError | SleepDailyResponse]:
...
def sync(
  *,
  ...
  tz_name: None | str | Unset = UNSET,
  tz_offset_mins: int | Unset = 0,
) -> HTTPValidationError | SleepDailyResponse | None:
  """Get Nightly Sleep Totals
  ...
  Returns:
      HTTPValidationError | SleepDailyResponse
  """
